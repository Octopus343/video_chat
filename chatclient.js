...
var myHostname = 'staging.hialabs.com';
if (!myHostname) {
...
const serverUrl = scheme + "://" + myHostname + ":5280/xmpp";
...
function onRoster(stanza) {
  ...
  function createConnection() {
        con = new Strophe.Connection(serverUrl);
...
function rebindOrConnect(serverUrl, jid, pass, sid, callback, onlyRebind) {
  createConnection();
  ...
  //   createConnection();
  //   rebindOrConnect(serverUrl, $("#name").val(), $("#password").val(), null, onConnect);
  // };
